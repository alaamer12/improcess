...
def GaussianLowPassFilter(image, sigma=30):
    """
    Apply Gaussian Low Pass Filter to an image
    Args:
        image: Input image
...
def GaussianLowPassFilter_freq_domain(image, sigma=1.0):
    """
    Apply Gaussian Low Pass Filter to frequency domain data
    Args:
